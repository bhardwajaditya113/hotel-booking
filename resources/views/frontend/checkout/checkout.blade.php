          ...
          <div id="stripe_pay" class="d-none">
              ...
              <div id="razorpay_info" class="d-none">
                  ...
                  <div class="alert alert-info">
                      ...
                      <br><small>Supports UPI, Credit/Debit Cards, NetBanking, and Wallets</small>
                  </div>
              </div>
...
$(document).ready(function () {
    ...
    $(".pay_method, #cash-on-delivery").on('click', function () {
...
$(function() {
    ...
    $('form.require-validation').bind('submit', function(e) {
          ...
          if (pay_method == undefined){
                ...
                return false;
          }else if(pay_method == 'COD' || pay_method == 'Razorpay'){
                // For COD and Razorpay, just submit the form
                return true;
          }else{
