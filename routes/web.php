...
Route::get('/locale/{locale}', [LocaleController::class, 'switch'])->name('locale.switch')->where('locale', 'en|ar|de|pt|zh_CN');
...
Route::middleware(['auth', 'roles:admin'])->group(function () {
    ...
    Route::get('/admin/dashboard/stats', [AdminController::class, 'AdminDashboardStats'])->name('admin.dashboard.stats');
...
Route::controller(BlogController::class)->group(function () {
    ...
    Route::get('/blog/cat/list/{id}', 'BlogCatList')->name('blog.cat.list');
});
...
// / Notification (requires login — admin header uses this)
Route::middleware(['auth'])->controller(BookingController::class)->group(function () {
    Route::post('/mark-notification-as-read/{notification}', 'MarkAsRead')->name('mark.notification.read');
});

Route::middleware(['auth'])->get('/portal/sync', [PortalSyncController::class, 'show'])->name('portal.sync');
...
Route::middleware(['auth'])->group(function () {
    Route::prefix('messages')->name('messages.')->group(function () {
        ...
        Route::get('/start', [MessageController::class, 'startConversationForm'])->name('start');
        Route::get('/{conversationId}', [MessageController::class, 'show'])->name('show');
        Route::post('/start', [MessageController::class, 'startConversation'])->name('start.post');
        Route::post('/{conversationId}/send', [MessageController::class, 'sendMessage'])->name('send');
        Route::post('/{conversationId}/archive', [MessageController::class, 'toggleArchive'])->name('archive');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/property/dashboard', [PropertyController::class, 'dashboard'])->name('property.dashboard');
    Route::get('/property/bookings/incoming', [PropertyController::class, 'incomingBookings'])->name('property.bookings.incoming');
    Route::post('/property/bookings/{booking}/approve', [PropertyController::class, 'approveBooking'])->name('property.bookings.approve');
    Route::post('/property/bookings/{booking}/decline', [PropertyController::class, 'declineBooking'])->name('property.bookings.decline');
    ...
    Route::post('/property/booking/store', [PropertyController::class, 'storeBooking'])->name('property.booking.store');
});

// Public property viewing
Route::get('/property/{id}/view', [PropertyController::class, 'show'])->name('property.view');
...
Route::prefix('search')->name('search.')->group(function () {
    ...
    Route::get('/map', [SearchController::class, 'mapView'])->name('map');
    Route::get('/compare', [SearchController::class, 'compare'])->name('compare');
    Route::get('/filter-counts', [SearchController::class, 'filterCounts'])->name('filter.counts');
});
