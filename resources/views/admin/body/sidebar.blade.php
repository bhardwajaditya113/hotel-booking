<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('admin.verification.properties.index') }}"><i class='bx bx-radio-circle'></i>Property Verification</a>
                </li>
                <li> <a href="{{ route('admin.verification.hosts.index') }}"><i class='bx bx-radio-circle'></i>Host Verification</a>
                </li>
            </ul>
        </li>
        ...
        <li class="menu-label">Enhanced Features</li>

        <li>
            <a href="javascript:;" class="has-arrow">
                <div class="parent-icon"><i class='bx bx-star'></i>
                </div>
                <div class="menu-title">Reviews Management</div>
            </a>
            <ul>
                <li> <a href="{{ route('admin.reviews.index') }}"><i class='bx bx-radio-circle'></i>All Reviews</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                ...
                <li> <a href="{{ route('admin.coupons.create') }}"><i class='bx bx-radio-circle'></i>Create Coupon</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">Pricing Rules</div>
            </a>
            <ul>
                <li> <a href="{{ route('admin.pricing.index') }}"><i class='bx bx-radio-circle'></i>All Pricing Rules</a>
                </li>
                <li> <a href="{{ route('admin.pricing.create') }}"><i class='bx bx-radio-circle'></i>Create Pricing Rule</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">Loyalty Rewards</div>
            </a>
            <ul>
                <li> <a href="{{ route('admin.loyalty.rewards.index') }}"><i class='bx bx-radio-circle'></i>All Rewards</a>
                </li>
                <li> <a href="{{ route('admin.loyalty.rewards.create') }}"><i class='bx bx-radio-circle'></i>Create Reward</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">Cancellation Policies</div>
            </a>
            <ul>
                <li> <a href="{{ route('admin.policies.index') }}"><i class='bx bx-radio-circle'></i>All Policies</a>
                </li>
                <li> <a href="{{ route('admin.policies.create') }}"><i class='bx bx-radio-circle'></i>Create Policy</a>
                </li>
            </ul>
        </li>
